...
/*static void LIDARFunction(Robot* robot) {
	lidarobject->loop();
}*/

void Robot::RobotInit() {
	//lidarobject = new LIDARClass();
	//lidarobject->LIDARinit();
	...
	//lidarTask= new Task("LIDAR", (FUNCPTR)LIDARFunction, Task::kDefaultPriority + 2);
	printf("Robot init!\n");
  }
